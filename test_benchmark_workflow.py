...
def test_benchmark_workflow():
    ...
    try:
        ...
        print(f"Location: ({test_basin['centroid_lat']:.6f}, {test_basin['centroid_lon']:.6f})")
...
def simulate_benchmark_execution():
    ...
    print(f"✓ Total simulated execution time: {sum(r['execution_time'] for r in results):.2f}s")
