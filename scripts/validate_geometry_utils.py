...
def test_initialization():
    ...
    try:
        ...
        assert (
            "geometry_repair" in diag.config
        ), "Config should contain geometry_repair section"
...
def test_statistics_and_recommendations():
    ...
    try:
        ...
        original_stats = {
            "total_features": 100,
            "total_invalid": 25,
            "issue_types": {"self_intersection": 10, "duplicate_points": 15},
        }
        ...
        recommendations = diag._generate_geometry_recommendations(
