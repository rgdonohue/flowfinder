...
class TestBenchmarkRunner:
    ...
    def test_flowfinder_delineation_success(self, mock_subprocess, sample_basin_data, sample_truth_polygons, temp_dir):
    ...
    @patch('subprocess.check_output')
    def test_flowfinder_delineation_timeout(self, mock_subprocess, sample_basin_data, sample_truth_polygons, temp_dir):
        """Test FLOWFINDER delineation timeout handling"""
        # Mock timeout
        mock_subprocess.side_effect = subprocess.TimeoutExpired(cmd="flowfinder", timeout=30)
    ...
    @patch('subprocess.check_output')
    def test_flowfinder_delineation_error(self, mock_subprocess, sample_basin_data, sample_truth_polygons, temp_dir):
        """Test FLOWFINDER delineation error handling"""
        # Mock error
        mock_subprocess.side_effect = subprocess.CalledProcessError(
            returncode=1, 
            cmd="flowfinder", 
            stderr=b"Error: Invalid coordinates"
        )
    ...
    def test_boundary_ratio_calculation(self, sample_truth_polygons, sample_predicted_polygons):
    ...
    def test_centroid_offset_calculation(self, sample_truth_polygons, sample_predicted_polygons):
    ...
    def test_metrics_calculation(self, sample_truth_polygons, sample_predicted_polygons):
    ...
    @patch('subprocess.check_output')
    def test_benchmark_execution(self, mock_subprocess, sample_basin_data, sample_truth_polygons, temp_dir):
    ...
    def test_report_generation(self, sample_basin_data, sample_truth_polygons, temp_dir):
    ...
    def test_complete_workflow(self, sample_basin_data, sample_truth_polygons, temp_dir):
