...
class TestBasinSampler:
    ...
    def test_pour_point_computation(
        self, sample_basins_gdf, sample_flowlines_gdf, setup_test_data_files
    ):
    ...
    def test_pour_point_snapping_logic(
        self, sample_basins_gdf, sample_flowlines_gdf, setup_test_data_files
    ):
    ...
    def test_terrain_roughness_calculation(
        self, sample_basins_gdf, setup_test_data_files
    ):
    ...
    def test_stream_complexity_calculation(
        self, sample_basins_gdf, sample_flowlines_gdf, setup_test_data_files
    ):
...
class TestBasinSamplerEdgeCases:
    ...
    def test_invalid_geometries(self, temp_dir):
        ...
        invalid_gdf = gpd.GeoDataFrame(
            {"HUC12": ["1201"], "STATES": ["CO"], "geometry": [invalid_polygon]},
            crs="EPSG:4326",
        )
