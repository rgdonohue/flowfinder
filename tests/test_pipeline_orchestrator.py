...
class TestBenchmarkPipeline:
    ...
    def test_dependency_checking(self, temp_dir):
        ...
        assert (
            pipeline._check_dependencies("truth_extraction") == False
        )  # Missing basin_sample.csv
    ...
    def test_retry_logic(self, temp_dir):
        ...
        with patch.object(pipeline, "_run_stage") as mock_run_stage:
            mock_run_stage.return_value = {"status": "success", "execution_time": 30.0}
...
class TestPipelineIntegration:
    ...
    def test_pipeline_status_tracking(self, temp_dir):
        ...
        assert (
            pipeline.pipeline_status["stage_results"]["basin_sampling"]["status"]
            == "success"
        )
